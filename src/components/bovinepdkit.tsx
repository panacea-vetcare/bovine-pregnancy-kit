    ...
    <>
      ...
      <div className="container-spacing">
        ...
        <div className="mt-4">
          ...
          <div>Cost-Effective: Reduces the need for expensive and time-consuming diagnostic methods like ultrasound, making it a cost-effective solution for regular herd monitoring.</div>
        </div>
        <div className="mt-4">
        ...
        <div className="mt-4">
          ...
          <div>For technical assistance or to reorder kits, please contact our customer service.
